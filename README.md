...
[Live Demo](https://retagaboshady.github.io/pomodoro-clock/)

* **A timer works by the pomodoro tecnik you can add and edit the time as you want and you will have to do list and a of of different features**

## Features

* **Theme: You will have black and white theme / mode to give you the theme you love / want**

* **Custom sessions: You will have the appality to custom/creat sessions to go with what are you doing**

* **To-do list: you will have to do list to help you to know what are you gonna do**
